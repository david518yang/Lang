...
const tests = [
  ...
  ["optimizes left ternary true", core.ternary(true, 55, 89), 55],
  ["optimizes left ternary false", core.ternary(false, 55, 89), 89],
  ...
  ["optimizes ternary", core.ternary(x, 1, 2), core.ternary(x, 1, 2)],
